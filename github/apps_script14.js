/**
 * 社内共有管理 v9.0 GitHub公開用サンプル名版（日報 他現場状況・選択式帳簿PDF版）（設定シート・免許資格・備品修理・帳簿PDF追加）
 *
 * - 担当者15人と既読確認者3人を分離
 * - 既読確認列は山田・高橋・鈴木の3列のみ
 * - 担当プルダウンは山田を先頭にした15人
...
function getSheetHeaders_() {
  ...
  "車検管理": ["車両名", "車番", "車検期限", "次回車検期限", "通知", "保険期限", "次回保険期限", "状態", "写真", READ_HEADER, ...personalMembers, "備考"],
  "車検履歴": ["更新日", "車両名", "車番", "旧車検期限", "新車検期限", "旧保険期限", "新保険期限", "担当", "備考"],
  ...
  "日報": ["日付", "入力者", "担当", "現場", "作業内容", "進捗", "問題点", "明日の予定", "他現場状況", "写真", "日報文章", "状態", "備考", READ_HEADER, ...personalMembers],
...
function rebuildDailyReportSheet() {
  ...
  sheet.getRange(2, 14, 500, 4).insertCheckboxes();
...
function setupDailyReportSheetOnly() {
  ...
  if (inputterCol > 0) {
    ...
    sheet.getRange(2, inputterCol, 500, 1)
